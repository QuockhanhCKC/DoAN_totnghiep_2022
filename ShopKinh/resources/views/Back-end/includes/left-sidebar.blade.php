    ...
    <div class="slimscroll-menu" id="remove-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu" id="side-menu">
                <li>
                    <a href="{{ route('Admin') }}" class="waves-effect @if($page == 'dashboard') mm-active @endif">
                ...
                @if (Auth::user()->vai_tro_id == 1)
                    <li>
                        <a href="" class="waves-effect @if($page == 'Nhân viên') mm-active @endif">
                    ...
                    <li>
                        <a href="" class="waves-effect @if($page == 'Khách hàng') mm-active @endif">
                ...
                <li>
                    <a href="" class="waves-effect @if($page == 'Nhà sản xuất') mm-active @endif">
                ...
                <li>
                    <a href="" class="waves-effect @if($page == 'Loại sản phẩm') mm-active @endif">
                ...
                <li>
                    <a href="" class="waves-effect @if($page == 'Sản phẩm') mm-active @endif">
                       <i class="fas fa-box"></i>
                        <span>Sản phẩm</span>
                    </a>
                </li>
                <li>
                    <a href="" class="waves-effect @if($page == 'Hóa đơn') mm-active @endif">
